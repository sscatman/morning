...
# --- 앱 기본 설정 ---
st.set_page_config(
    page_title="위험도 분석 V0.64 (가중치 최적화)", 
    page_icon="📊",
    layout="wide"
)
...
st.markdown(f"""<div class="header-title">📊 위험도 분석 V0.64 (가중치 최적화)</div><div class="sub-info">📍 대전: {weather} | 🕒 {kst_now.strftime('%Y-%m-%d %H:%M')} (한국시간)</div>""", unsafe_allow_html=True)
